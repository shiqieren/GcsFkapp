package com.gcs.fengkong.ui.notice;
...
import com.gcs.fengkong.BuildConfig;
...
public final class NoticeManager {
    ...
    public static void publish(ResultBean resultBean, NoticeBean newNotice) {
        if (resultBean != null && resultBean.isOk() && newNotice != null) {
            MyLog.d("NoticeManager", "publish:" + newNotice.toString());
            NoticeServer.arrivedMsgAction(GlobalApplication.getInstance(), newNotice);
        }
    }
